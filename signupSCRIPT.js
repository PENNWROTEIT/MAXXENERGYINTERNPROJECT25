...
"; //
  const backendUrl = "http://127.0.0.1:4040/inspect/http"; // <--BACKEND URL
    ...
    const signupData = {
      ...
      // Add more fields here if your backend expects them
    };
    ...
    fetch(backendUrl, {
      ...
      .then(async response => {
        ...
        feedbackDiv.textContent = "Registration successful! " + (data.message || "Thank you for signing up with MAXX ENERGY! Access your account now!");
